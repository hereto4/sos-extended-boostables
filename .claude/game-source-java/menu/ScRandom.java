...
class ScRandom extends Shadower implements SC{
	...
	ScRandom(Menu menu){
		...
		options.addRelBody(8, DIR.S, new RENDEROBJ.RenderImp(MenuScreen.inner.width()-4, 32) {
		...
		ArrayListGrower<Setting> setts = new ArrayListGrower<ScRandom.Setting>();
		Setting sett;
...
//			s.addRightC(64, c);
		...
		options.addRelBody(16, DIR.S, new RENDEROBJ.RenderImp(MenuScreen.inner.width()-4, 32) {
