...
public class GPanel extends CLICKABLE.ClickableAbs {
	...
	private final RecFacade outer = new RecFacade() {
		...
		@Override
		public int width() {
			return body.width() + MW * 2 +(clickAction != null ? 8 : 0);
		}

		@Override
		public int height() {
			return body.height() + MW * 2 + titleHeight() / 2 + (clickAction != null ? 8 : 0);
		}

		@Override
		public int y1() {
			return body.y1() - MW - titleHeight() / 2 - (clickAction != null ? 8 : 0);
		}
		...
		public RecFacade setWidth(double width) {
			body.setWidth(width - MW * 2 + (clickAction != null ? 8 : 0));
			return this;
		}

		@Override
		public RecFacade setHeight(double height) {
			body.setHeight(height - MW * 2 - titleHeight() / 2 + (clickAction != null ? 8 : 0));
			return this;
		}
	};
