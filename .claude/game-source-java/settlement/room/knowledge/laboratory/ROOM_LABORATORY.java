...
public final class ROOM_LABORATORY extends RoomBlueprintIns<LaboratoryInstance> implements ROOM_ADMIN_HOLDER, ROOM_CONSUMPTION_HASER{
	...
	private static CharSequence ¤¤TargetD = "¤Estimation of how much innovation that can be produced and maintained:";

	static {
		D.ts(ROOM_LABORATORY.class);
	}
	...
	public void appendView(LISTE<UIRoomModule> mm) {
		...
		mm.add(new AdminData.Gui<LaboratoryInstance, ROOM_LABORATORY>(this, data, consumption, BOOSTABLES.CIVICS().INNOVATION.name, ¤¤TargetD).make());
