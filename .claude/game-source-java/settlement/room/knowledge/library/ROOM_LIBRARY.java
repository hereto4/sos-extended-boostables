...
public final class ROOM_LIBRARY extends RoomBlueprintIns<LibraryInstance> implements ROOM_ADMIN_HOLDER, ROOM_CONSUMPTION_HASER{
	...
	private static CharSequence ¤¤TargetD = "¤Estimation of how much knowledge will be produced.";
	private static CharSequence ¤¤name = "¤Knowledge";
	...
	public void appendView(LISTE<UIRoomModule> mm) {
		...
		mm.add(new AdminData.Gui<LibraryInstance, ROOM_LIBRARY>(this, data, consumption, ¤¤name, ¤¤TargetD).make());
	}
