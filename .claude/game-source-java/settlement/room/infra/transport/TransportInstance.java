...
public final class TransportInstance extends RoomInstance implements JOBMANAGER_HASER, ROOM_RADIUS_INSTANCE, ROOM_MOVEJOBBER, ROOM_MOVE_DEST, MoveOrderPullInstance{
	...
	public void deliveryJobCancel() {
		delivering = false;
	}
	
	public int doDeliveryJob() {
		delivering = false;
		int am = data.stored();
		data.go();
		return am;
