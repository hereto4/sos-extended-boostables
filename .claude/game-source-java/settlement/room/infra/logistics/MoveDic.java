...
public class MoveDic {
	...
	public static CharSequence ¤¤keep = "¤Keep Limit";
	...
	public static CharSequence ¤¤fetchLim = "¤Fetch Limit.";
	public static CharSequence ¤¤fetchLimD = "¤This room will only fetch if the current storage is less than this limit.";
