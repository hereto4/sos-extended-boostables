...
//	final Industry productionData;
	...
	public ROOM_PASTURE(RoomInitData data, String key, RoomCategorySub cat, int index) throws IOException {
		...
		if (false) {
			//indoor pasture placement suck. The new cut off jobs should only work with constrution, not clearing.
			
			//adults + animal room boost need to have a better name.
		}
...
//			data.data().error("Can't declare more than 3 output in industry!", "");
		...
		irri = new RoomIrrigated(this, bonus, 0.05, 1.0) {
